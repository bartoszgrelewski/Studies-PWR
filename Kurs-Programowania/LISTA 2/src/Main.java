...
//KOLO
            if(symbolFigura == 'o'){
                ...
                try{
                    ...
                    if(zmienna>0){
                        Kolo obiektKolo = new Kolo(zmienna);
                ...
                try {
                    ...
                    if (kat > 0 && kat < 180){
                        ...
                        if ((boki[0] == boki[1]) && (boki[1] == boki[2]) && (boki[2] == boki[3])) {
                            if (kat == 90) {
                                Kwadrat obiektKwadrat = new Kwadrat(boki[0]);
                                Tablica[i] = obiektKwadrat;
                            } else {
                                Romb obiektRomb = new Romb((boki[0]), (kat));
                                Tablica[i] = obiektRomb;
                            }
                        } else {
                            Prostokat obiektProstokat = new Prostokat((boki[0]), (boki[2]));
...
//PIECIOKAT
                ...
                try{
                    zmienna = Double.parseDouble(args[licznik]); //KONWERTOWANIE
                    if(zmienna>0){
                        Pieciokat obiektPieciokat = new Pieciokat(zmienna);
...
//SZESCIOKAT
                ...
                try{
                    zmienna = Double.parseDouble(args[licznik]); //KONWERTOWANIE
                    if(zmienna>0){
                        Szesciokat obiektSzesciokat = new Szesciokat(zmienna);
